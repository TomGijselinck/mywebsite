/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+latex&plugins=line-numbers */
...
!function (e) {
    var t = {variable: /\$(?:[a-zA-Z0-9_#\?\-\*!@]+|\{[^}]+\})/};
    e.languages.bash = e.languages.extend("clike", {
    ...
    }), e.languages.insertBefore("bash", "keyword", t), e.languages.insertBefore("bash", "comment", {
        shebang: {
